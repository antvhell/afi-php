...
window.onload = function () {
  var letras = ["a", "s", "ʋ", "j", "e", "ɲ", "i", "ɹ", "o", "u", "k"];
...
function regresar() {
  ...
  if (palabras[indice] === "kaʋa") {
    document.getElementById("reiniciar").style.visibility = "visible";
    document.getElementById("empezar").style.visibility = "hidden";
  }
  if (palabras[indice] === "soɹo") {
    document.getElementById("reiniciar").style.visibility = "visible";
  }
  if (palabras[indice] === "ojo") {
    document.getElementById("reiniciar").style.visibility = "visible";
  }
}
...
function finJuego(cadena) {
  ...
  if (palabras[indice] === "kaʋa") {
    document.getElementById("glosa").innerHTML = `'tepetate' en mixteco`;
    glosa.classList.add("alert", "alert-success");
  }

  if (palabras[indice] === "soɹo") {
    document.getElementById("glosa").innerHTML = `'hablar' en yoruba`;
    glosa.classList.add("alert", "alert-success");
  }

  if (palabras[indice] === "ojo") {
    document.getElementById("glosa").innerHTML = `'loro' en huasteco. SLP.`;
    glosa.classList.add("alert", "alert-success");
  } else {
  }
}
