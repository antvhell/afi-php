...
window.onload = function () {
  var letras = ["a", "l", "e", "ʎ", "ɭ", "i", "ʃ", "o", "u", "ʟ"];
...
function regresar() {
  ...
  if (palabras[indice] === "lo") {
    document.getElementById("reiniciar").style.visibility = "visible";
    document.getElementById("empezar").style.visibility = "hidden";
  }
  if (palabras[indice] === "ʃiʎu") {
    document.getElementById("reiniciar").style.visibility = "visible";
  }
  if (palabras[indice] === "ʟo") {
    document.getElementById("reiniciar").style.visibility = "visible";
  }
}
...
function finJuego(cadena) {
  ...
  if (palabras[indice] === "lo") {
    console.log(indice);
    // document.getElementById('glosa').style.visibility = "visible";
    document.getElementById("glosa").innerHTML = `'carga' en chinanteco`;
    glosa.classList.add("alert", "alert-success");
  }
  if (palabras[indice] === "ʃiʎu") {
    console.log(indice);
    // document.getElementById('glosa').style.visibility = "visible";
    document.getElementById("glosa").innerHTML = `'ayate' en ocuilteco`;
    glosa.classList.add("alert", "alert-success");
  }

  if (palabras[indice] === "ʟo") {
    console.log(indice);
    document.getElementById("glosa").innerHTML = `'piel de persona' en chinanteco`;
    glosa.classList.add("alert", "alert-success");
  } else {
  }
}
