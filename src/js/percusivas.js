...
window.onload = function () {
  var letras = ["a", "ɾ", "e", "p", "i", "b", "n", "ɽ", "z", "o", "u"];
...
function regresar() {
  ...
  if (palabras[indice] === "nziziɾiɾi") {
    document.getElementById("reiniciar").style.visibility = "visible";
    document.getElementById("empezar").style.visibility = "hidden";
  }
  if (palabras[indice] === "beɽa") {
    document.getElementById("reiniciar").style.visibility = "visible";
  }
}
...
function finJuego(cadena) {
  ...
  if (palabras[indice] === "nziziɾiɾi") {
    console.log(indice);
    // document.getElementById('glosa').style.visibility = "visible";
    document.getElementById("glosa").innerHTML = `'amarillo' en mina`;
    glosa.classList.add("alert", "alert-success");
  }

  if (palabras[indice] === "beɽa") {
    console.log(indice);
    document.getElementById("glosa").innerHTML = `'bahía' en bengalí`;
    glosa.classList.add("alert", "alert-success");
  } else {
  }
}
