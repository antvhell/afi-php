...
window.onload = function () {
  var letras = ["ɳ", "a", "ʔ", "m", "ŋ", "t", "e", "ɴ", "p", "ɲ", "ɡ", "i", "n", "o", "ɱ", "u"];
...
var palabras = ["", "manu", "ɲuɲu", "ɡoɳona", "moŋpa"];
...
function regresar() {
  ...
  if (palabras[indice] === "manu") {
    document.getElementById("reiniciar").style.visibility = "visible";
    document.getElementById("empezar").style.visibility = "hidden";
  }
  if (palabras[indice] === "ɲuɲu") {
    document.getElementById("empezar").style.visibility = "visible";
    document.getElementById("reiniciar").style.visibility = "visible";
  }

  // if (palabras[indice] === "toʔna") {
  //   document.getElementById("empezar").style.visibility = "visible";
  //   document.getElementById("reiniciar").style.visibility = "visible";
  // }

  if (palabras[indice] === "ɡoɳona") {
    document.getElementById("empezar").style.visibility = "visible";
    document.getElementById("reiniciar").style.visibility = "visible";
  }

  if (palabras[indice] === "moŋpa") {
    document.getElementById("reiniciar").style.visibility = "visible";
  }
}
...
function finJuego(cadena) {
  ...
  if (palabras[indice] === "manu") {
    document.getElementById("glosa").innerHTML = `'amarillo' huasteco. SLP`;
    glosa.classList.add("alert", "alert-success");
  }
  if (palabras[indice] === "ɲuɲu") {
    document.getElementById("glosa").innerHTML = `'presumidos' en mixteco`;
    glosa.classList.add("alert", "alert-success");
  }

  // if (palabras[indice] === "toʔna") {
  //   document.getElementById("glosa").innerHTML = `'tizne' en zoque`;
  //   glosa.classList.add("alert", "alert-success");
  // }

  if (palabras[indice] === "ɡoɳona") {
    document.getElementById("glosa").innerHTML = `'contar, calcular' en bengalí`;
    glosa.classList.add("alert", "alert-success");
  }

  if (palabras[indice] === "moŋpa") {
    document.getElementById("glosa").innerHTML = `'está durmiendo' en popoluca`;
    glosa.classList.add("alert", "alert-success");
  } else {
  }
}
