...
var palabras = ["", "ʦuʔʦũ", "kaɡĩ", "edã", "ʦotõ", "ẽʔẽ"];
...
function regresar() {
  ...
  if (palabras[indice] === "ʦuʔʦũ") {
    document.getElementById("reiniciar").style.visibility = "visible";
    document.getElementById("empezar").style.visibility = "hidden";
  }
  if (palabras[indice] === "kaɡĩ") {
    document.getElementById("reiniciar").style.visibility = "visible";
  }
  if (palabras[indice] === "edã") {
    document.getElementById("reiniciar").style.visibility = "visible";
  }
  if (palabras[indice] === "ʦotõ") {
    document.getElementById("reiniciar").style.visibility = "visible";
  }

  if (palabras[indice] === "ẽʔẽ") {
    document.getElementById("reiniciar").style.visibility = "visible";
  }
}
...
function finJuego(cadena) {
  ...
  if (palabras[indice] === "ʦuʔʦũ") {
    document.getElementById("glosa").innerHTML = `'colibrí' en tlapaneco`;
    glosa.classList.add("alert", "alert-success");
  }
  if (palabras[indice] === "kaɡĩ") {
    document.getElementById("glosa").innerHTML = `'alegre' en tlapaneco`;
    glosa.classList.add("alert", "alert-success");
  }
  if (palabras[indice] === "edã") {
    document.getElementById("glosa").innerHTML = `'víbora' en miná`;
    glosa.classList.add("alert", "alert-success");
  }
  if (palabras[indice] === "ʦotõ") {
    document.getElementById("glosa").innerHTML = `'chivo' en tlapaneco`;
    glosa.classList.add("alert", "alert-success");
  }

  if (palabras[indice] === "ẽʔẽ") {
    document.getElementById("glosa").innerHTML = `'carrizo' en tlapaneco`;
    glosa.classList.add("alert", "alert-success");
  } else {
  }
}
