          ...
          <div class="modal-dialog modal-dialog-centered modal-md">
            <div class="modal-content">
              <div class="modal-header">
                <h5 class="modal-title" id="exampleModalLabel">Espectrograma de la vocal [ u ]</h5>
                <button class="btn-close" type="button" data-bs-dismiss="modal" aria-label="Close"></button>
              </div>
              <div class="modal-body">
                <div class="container">
                  <div class="row">
                    <div class="col"><img class="img-fluid" src="../../../../build/img/u-espect.png" alt="u Espectrograma"></div>
                  </div>
                </div>
              </div>
...
<main class="flex-grow-1 container">
        <div class="row mt-4">
          ...
          <div class="col-s-12 col-md-6 col-l-6 col-xl-6 videos mt-4">
            <video class="embed-responsive video ratio ratio-16x9" id="videoplay" controlslist="nodownload" poster="../../../build/img/u.jpg">
              <source src="../../build/videos/u.mp4" type="video/mp4">
            </video>
            ...
            <p class="card-text mt-3">Es una vocal alta posterior redondeada. Se produce con una elevación del dorso de la lengua que casi toca la zona del velo. Los labios se mantienen redondeados.</p>
            <p><a class="link-primary text-decoration-none" href="" data-bs-toggle="modal" ="" data-bs-target="#exampleModal5">Ver espectrograma 
