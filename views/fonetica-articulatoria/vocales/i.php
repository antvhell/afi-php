...
<main class="flex-grow-1 container">
        <div class="row mt-4">
          ...
          <div class="col-s-12 col-md-6 col-l-6 col-xl-6 videos mt-4">
            <video class="embed-responsive video ratio ratio-16x9" id="videoplay" controlslist="nodownload" poster="../../../build/img/i.jpg">
              <source src="../../build/videos/i.mp4" type="video/mp4">
            </video>
            ...
            <p class="card-text mt-3">Es una vocal alta anterior no redondeada. En su articulación el cuerpo de la lengua se eleva, casi tocando la parte superior de la boca. La elevación se produce hacia la parte anterior (los alvéolos). Los labios se mantienen extendidos.</p>
            <p><a class="link-primary text-decoration-none" href="" data-bs-toggle="modal" ="" data-bs-target="#exampleModal2">Ver espectrograma 
