...
<main class="flex-grow-1 container">
        <div class="row mt-4">
          <div class="col">
            <div class="d-flex"><a class="link-danger link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover opacity-70 flecha" href="../africadas/ʦ" title="Regresar">
              ...
              <h2 class="fw-light mb-4">Transcripción. Oclusivas y Africadas</h2>
            </div>
            <p class="mt-4">Escuche la palabra con
              <svg class="bi bi-play-circle btn-play" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewbox="0 0 16 16">
                <path d="M8 15A7 7 0 1 1 8 1a7 7 0 0 1 0 14zm0 1A8 8 0 1 0 8 0a8 8 0 0 0 0 16z"></path>
                <path d="M6.271 5.055a.5.5 0 0 1 .52.038l3.5 2.5a.5.5 0 0 1 0 .814l-3.5 2.5A.5.5 0 0 1 6 10.5v-5a.5.5 0 0 1 .271-.445z"> </path>
              </svg> y pulse los símbolos del teclado para dar la transcripción
            </p>
            <p id="indice"></p>
          </div>
        </div>
        ...
        <script src="../../../../assets/js/transcripcion-oclusivas.js"></script>
      </main>
...
<?php
    $script = "
        <script src='../../build/js/transcripcion-oclusivas.js'></script>
    "
?>