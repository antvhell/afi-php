...
<main class="flex-grow-1 container">
        ...
        <div class="row mt-4 text-center">
          <div class="col-12 mt-4">
            <ul class="nav nav-tabs justify-content-center">
              <li class="nav-item"><a class="nav-item nav-link active" href="/fonetica-articulatoria/africadas/simbolos-y-caracteristicas/ejercicio-1" aria-current="page">Ejercicio 1</a></li>
        ...
        <div class="row mt-4">
          <p>1. Arrastre a la caja la característica correspondiente a cada símbolo.</p>
        </div>
        <div class="row mt-4">
          <p class="textafi">[ ʣ ]</p>
        ...
        <div class="d-flex mb-3 mt-4"><a class="btn btn-outline-primary ml-auto js-btn-next ms-auto p-2" type="button" title="Siguiente" href="/fonetica-articulatoria/africadas/simbolos-y-caracteristicas/ejercicio-2">Ejercicio 2
