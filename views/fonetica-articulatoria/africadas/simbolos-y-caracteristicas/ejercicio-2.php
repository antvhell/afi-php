...
<main class="flex-grow-1 container">
        ...
        <div class="row mt-4 text-center">
          <div class="col-12 mt-4">
            <ul class="nav nav-tabs justify-content-center">
              ...
              <li class="nav-item"><a class="nav-item nav-link active" href="/fonetica-articulatoria/africadas/simbolos-y-caracteristicas/ejercicio-2">Ejercicio 2</a></li>
              <li class="nav-item"><a class="nav-item nav-link" href="/fonetica-articulatoria/africadas/simbolos-y-caracteristicas/ejercicio-3">Ejercicio 3</a></li>
            </ul>
          </div>
        </div>
        <div class="row mt-4">
          <p>2. Arrastre a la caja la característica correspondiente a cada símbolo</p>
        </div>
        <div class="row mt-4">
          <p class="text-charis">[ ʧ ]</p>
          ...
          <div class="col-sm-6 col-md-12 col-lg-6 col-xl-6 mt-2">
            <div id="drag-elements">
              ...
              <div class="bien">Postalveolar</div>
              <div class="mal">Velar</div>
            </div>
          </div>
        </div>
        <div class="row mt-4">
          <p class="text-charis">[ ʤ ]</p>
          <div class="col-sm-6 col-md-12 col-lg-6 col-xl-6 mt-2">
            <div id="drop-target2"></div>
          </div>
          <div class="col-sm-6 col-md-12 col-lg-6 col-xl-6 mt-2">
            <div id="drag-elements2">
              <div class="mal">Retrofleja</div>
              <div class="mal">Alveolar</div>
              <div class="bien">Postalveolar</div>
            </div>
          </div>
        ...
        <div class="row mt-4">
          <p class="text-charis">[ ʦ ]</p>
          <div class="col-sm-6 col-md-12 col-lg-6 col-xl-6 mt-2">
            <div id="drop-target3"></div>
          </div>
          <div class="col-sm-6 col-md-12 col-lg-6 col-xl-6 mt-2">
            <div id="drag-elements3">
              <div class="mal">Postalveolar</div>
              <div class="bien">Alveolar</div>
              <div class="mal">Velar</div>
            </div>
          </div>
        </div>
        <div class="row mt-4">
          <p class="text-charis">[ ʣ ]</p>
          <div class="col-sm-6 col-md-12 col-lg-6 col-xl-6 mt-2">
          ...
          <div class="col-sm-6 col-md-12 col-lg-6 col-xl-6 mt-2">
            <div id="drag-elements4">
              <div class="bien">Alveolar</div>
              <div class="mal">Dental</div>
              <div class="mal">Postalveolar</div>
            </div>
          </div>
        </div>
        <div class="d-flex mb-3 mt-4"><a class="btn btn-outline-primary p-2" href="/fonetica-articulatoria/africadas/simbolos-y-caracteristicas/ejercicio-1" role="button">
            ...
            </svg>Ejercicio 1</a><a class="btn btn-outline-primary ml-auto js-btn-next ms-auto p-2" type="button" title="Siguiente" href="/fonetica-articulatoria/africadas/simbolos-y-caracteristicas/ejercicio-3">Ejercicio 3
