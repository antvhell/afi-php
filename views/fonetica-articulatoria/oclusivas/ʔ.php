...
<main class="flex-grow-1 container">
        <div class="row mt-4">
          ...
          <div class="col-s-12 col-md-6 col-l-6 col-xl-6 videos mt-4">
            <video class="embed-responsive video ratio ratio-16x9" id="videoplay" controlslist="nodownload" poster="../../build/img/ʔ.jpg">
              <source src="../../build/videos/ʔ.mp4" type="video/mp4">
            </video>
            ...
            <p class="card-text mt-3">Es una consonante oclusiva glotal <b>sorda</b>. En su articulación las cuerdas vocales se juntan y bloquean el paso del aire, esto impide que puedan vibrar. Cuando se separan, el aire sale abruptamente.</p>
          </div>
        </div>
      </main>
