...
<main class="flex-grow-1 container">
        <div class="row mt-4">
          ...
          <div class="col-s-12 col-md-6 col-l-6 col-xl-6 videos mt-4">
            <video class="embed-responsive video ratio ratio-16x9" id="videoplay" controlslist="nodownload" poster="../../build/img/ʈ.jpg">
              <source src="../../build/videos/ʈ.mp4" type="video/mp4">
            </video>
            ...
            <p class="card-text mt-3">Es una consonante oclusiva <b>sorda</b> (retrofleja) que se articula en la región postalveolar. En su articulación la punta de la lengua se levanta y adquiere una forma curva que se mueve hacia el paladar. En su realización no hay vibración de las cuerdas.</p>
          </div>
        </div>
      </main>
