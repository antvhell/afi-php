...
<main class="flex-grow-1 container">
        <div class="row mt-4">
          ...
          <div class="col-s-12 col-md-6 col-l-6 col-xl-6 videos mt-4">
            <video class="embed-responsive video ratio ratio-16x9" id="videoplay" controlslist="nodownload" poster="../../build/img/ɖ.jpg">
              <source src="../../build/videos/ɖ.mp4" type="video/mp4">
            </video>
            ...
            <p class="card-text mt-3">Es una consonante oclusiva <b>sonora</b> (retrofleja) que se articula en la región postalveolar. Se produce con vibración de las cuerdas. La punta de la lengua se levanta y adquiere una forma curva que se mueve hacia el paladar.</p>
          </div>
        </div>
      </main>
