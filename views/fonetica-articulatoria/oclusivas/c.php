...
<main class="flex-grow-1 container">
        <div class="row mt-4">
          ...
          <div class="col-s-12 col-md-6 col-l-6 col-xl-6 videos mt-4">
            <video class="embed-responsive video ratio ratio-16x9" id="videoplay" controlslist="nodownload" poster="../../build/img/c.jpg">
              <source src="../../build/videos/c.mp4" type="video/mp4">
            </video>
            ...
            <p class="card-text mt-3">Es una consonante oclusiva palatal <b>sorda</b>. En su articulación no hay vibración de las cuerdas. La oclusión se forma por el contacto de la parte media de la lengua con el paladar duro. Cuando se suelta la oclusión el aire sale abruptamente.</p>
          </div>
        </div>
      </main>
