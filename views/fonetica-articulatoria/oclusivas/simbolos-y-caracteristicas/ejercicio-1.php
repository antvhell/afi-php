...
<main class="flex-grow-1 container">
        ...
        <div class="row mt-4 text-center">
          <div class="col-12 mt-4">
            <ul class="nav nav-tabs justify-content-center">
              <li class="nav-item"><a class="nav-item nav-link active" href="/fonetica-articulatoria/oclusivas/simbolos-y-caracteristicas/ejercicio-1" aria-current="page">Ejercicio 1</a></li>
        ...
        <div class="row mt-4">
          <p>1. Arrastre al interior de la caja las características correspondientes a cada símbolo.</p>
        </div>
        <div class="row mt-4">
          <p class="textafi">[ p ]</p>
          ...
          <div class="col-sm-6 col-md-12 col-lg-6 col-xl-6 mt-2">
            <div id="drag-elements">
              ...
              <div class="bien">Bilabial</div>
              <div class="mal">Uvular</div>
              <div class="mal">Palatal</div>
              <div class="bien">Oclusivo</div>
        ...
        <div class="d-flex mb-3 mt-4"><a class="btn btn-outline-primary ml-auto js-btn-next ms-auto p-2" type="button" title="Siguiente" href="/fonetica-articulatoria/oclusivas/simbolos-y-caracteristicas/ejercicio-2">Ejercicio 2
