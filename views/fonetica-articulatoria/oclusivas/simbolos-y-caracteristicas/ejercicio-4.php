...
<main class="flex-grow-1 container">
        ...
        <div class="row mt-4 text-center">
          <div class="col-12 mt-4">
            <ul class="nav nav-tabs justify-content-center">
              ...
              <li class="nav-item"><a class="nav-item nav-link" href="/fonetica-articulatoria/oclusivas/simbolos-y-caracteristicas/ejercicio-3">Ejercicio 3</a></li>
              <li class="nav-ite"><a class="nav-item nav-link active" href="/fonetica-articulatoria/oclusivas/simbolos-y-caracteristicas/ejercicio-4">Ejercicio 4</a></li>
        ...
        <p>4. Pulse el símbolo correspondiente a la información del corchete.</p>
        <div class="row col-sm-12 col-xl-12 align-items-center justify-content-center text-center mt-4">
          <div class="droparea col-6 ui-droppable">
            <p>[ Oclusivo, velar, sordo ]</p>
            <div class="simbolFalse box">t</div>
            <div class="simbolFalse box">G</div>
            <div class="simbolFalse box">ɟ</div>
            <div class="simbolTrue box">k</div>
          </div>
        </div>
        <div class="row col-sm-12 col-xl-12 align-items-center justify-content-center text-center mt-4">
          <div class="droparea col-6 ui-droppable">
            <p>[ Oclusivo, palatal, sonoro ]</p>
            <div class="simbolFalse box">t</div>
            <div class="simbolTrue box">ɟ</div>
            <div class="simbolFalse box"> G</div>
            <div class="simbolFalse box"> k</div>
          </div>
        </div>
        <div class="row col-sm-12 col-xl-12 align-items-center justify-content-center text-center mt-4">
          <div class="droparea col-6 ui-droppable">
            <p>[ Oclusivo, alveolar, sordo ]</p>
            <div class="simbolTrue box">t</div>
            <div class="simbolFalse box"> G</div>
            <div class="simbolFalse box"> k</div>
            <div class="simbolFalse box">ɟ</div>
          </div>
        ...
        <div class="row col-sm-12 col-xl-12 align-items-center justify-content-center text-center mt-4">
          <div class="droparea col-6 ui-droppable">
            <p>[ Oclusivo, uvular, sonoro ]</p>
            <div class="simbolFalse box">k</div>
            <div class="simbolFalse box">t</div>
            <div class="simbolTrue box">G</div>
            <div class="simbolFalse box">ɟ</div>
          </div>
        </div>
        <div class="d-flex mb-3 mt-4"><a class="btn btn-outline-primary p-2" href="/fonetica-articulatoria/oclusivas/simbolos-y-caracteristicas/ejercicio-3" role="button">
            ...
            </svg>Ejercicio 3</a><a class="btn btn-outline-primary ml-auto js-btn-next ms-auto p-2" type="button" title="Siguiente" href="/fonetica-articulatoria/oclusivas/simbolos-y-caracteristicas/ejercicio-5">Ejercicio 5
