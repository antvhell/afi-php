...
<main class="flex-grow-1 container">
        ...
        <div class="row mt-4 text-center">
          <div class="col-12 mt-4">
            <ul class="nav nav-tabs justify-content-center">
              ...
              <li class="nav-item"><a class="nav-item nav-link active" href="/fonetica-articulatoria/oclusivas/simbolos-y-caracteristicas/ejercicio-2">Ejercicio 2</a></li>
        ...
        <div class="row mt-4">
          <p>2. Arrastre el símbolo que corresponde a la descripción articulatoria dada en los corchetes.</p>
        </div>
        <div class="row align-items-center justify-content-center mt-4">
          <p>[ Oclusivo, uvular, sordo ]</p>
        ...
        <div class="row mt-4">
          <p>[ Oclusivo, retroflejo, sonoro ]</p>
          <div class="col-sm-6 col-md-12 col-lg-6 col-xl-6 mt-2">
          ...
          <div class="col-sm-6 col-md-12 col-lg-6 col-xl-6 mt-2">
            <div id="drag-elements2">
              <div class="mal"> k</div>
              <div class="mal">d</div>
              <div class="bien">ɖ</div>
            </div>
          </div>
        </div>
        <div class="row mt-4">
          <p>[ Oclusivo, glotal, sordo ]</p>
          <div class="col-sm-6 col-md-12 col-lg-6 col-xl-6 mt-2">
        ...
        <div class="d-flex mb-3 mt-4"><a class="btn btn-outline-primary p-2" href="/fonetica-articulatoria/oclusivas/simbolos-y-caracteristicas/ejercicio-1" role="button">
            ...
            </svg>Ejercicio 1</a><a class="btn btn-outline-primary ml-auto js-btn-next ms-auto p-2" type="button" title="Siguiente" href="/fonetica-articulatoria/oclusivas/simbolos-y-caracteristicas/ejercicio-3">Ejercicio 3
