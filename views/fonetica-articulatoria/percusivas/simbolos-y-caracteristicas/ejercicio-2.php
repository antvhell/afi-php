...
<main class="flex-grow-1 container">
        ...
        <div class="row mt-4 text-center">
          <div class="col-12 mt-4">
            <ul class="nav nav-tabs justify-content-center">
              <li class="nav-item"><a class="nav-item nav-link" href="/fonetica-articulatoria/percusivas/simbolos-y-caracteristicas/ejercicio-1" aria-current="page">Ejercicio 1</a></li>
              <li class="nav-item"><a class="nav-item nav-link active" href="/fonetica-articulatoria/percusivas/simbolos-y-caracteristicas/ejercicio-2">Ejercicio 2</a></li>
            </ul>
          </div>
        </div>
        <div class="row mt-4">
        ...
        <div class="row">
          <div class="col">
            <section class="memory-game">
              <div class="memory-card" data-simbolos="vibrante-simple-alveolar"><img class="front-face" src="../../../build/img/vibrante-simple-alveolar-descripcion.svg" alt="vibrante-simple-alveolar"><img class="back-face" src="../../../build/img/lef-fondo.svg" alt="LEF fondo"></div>
              <div class="memory-card" data-simbolos="vibrante-simple-alveolar"><img class="front-face" src="../../../build/img/vibrante-simple-alveolar-simbolo.svg" alt="vibrante-simple-alveolar"><img class="back-face" src="../../../build/img/lef-fondo.svg" alt="LEF fondo"></div>
              ...
              <div class="memory-card" data-simbolos="vibrante-simple-retrofleja"><img class="front-face" src="../../../build/img/vibrante-simple-retrofleja-descripcion.svg" alt="vibrante-simple-retrofleja"><img class="back-face" src="../../../build/img/lef-fondo.svg" alt="LEF fondo"></div>
              <div class="memory-card" data-simbolos="vibrante-simple-retrofleja"><img class="front-face" src="../../../build/img/vibrante-simple-retrofleja-simbolo.svg" alt="vibrante-simple-retrofleja"><img class="back-face" src="../../../build/img/lef-fondo.svg" alt="LEF fondo"></div>
              <div class="memory-card" data-simbolos="vibrante-simple-labiodental"><img class="front-face" src="../../../build/img/vibrante-simple-labiodental-simbolo.svg" alt="vibrante-simple-labiodental"><img class="back-face" src="../../../build/img/lef-fondo.svg" alt="LEF fondo"></div>
              <div class="memory-card" data-simbolos="vibrante-simple-labiodental"><img class="front-face" src="../../../build/img/vibrante-simple-labiodental-descripcion.svg" alt="vibrante-simple-labiodental"><img class="back-face" src="../../../build/img/lef-fondo.svg" alt="LEF fondo"></div>
        ...
        <div class="d-flex mb-3 mt-4"><a class="btn btn-outline-primary p-2" href="/fonetica-articulatoria/percusivas/simbolos-y-caracteristicas/ejercicio-1" role="button">
