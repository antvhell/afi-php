...
<main class="flex-grow-1 container">
        <div class="row mt-4">
          ...
          <div class="col-s-12 col-md-6 col-l-6 col-xl-6 videos mt-4">
            <video class="embed-responsive video ratio ratio-16x9" id="videoplay" controlslist="nodownload" poster="../../../build/img/ʕ.jpg">
              <source src="../../build/videos/ʕ.mp4" type="video/mp4">
            </video>
            ...
            <p class="card-text mt-3">Es una consonante fricativa faríngea <b>sonora</b>. En esta consonante las cuerdas vocales vibran. La articulación comienza por la retracción de la raíz de la lengua, después la laringe se estrecha y cuando el aire pasa por ese estrechamiento se produce la fricción.</p>
          </div>
        </div>
      </main>
