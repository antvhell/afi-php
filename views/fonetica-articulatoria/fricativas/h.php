...
<main class="flex-grow-1 container">
        <div class="row mt-4">
          ...
          <div class="col-s-12 col-md-6 col-l-6 col-xl-6 videos mt-4">
            <video class="embed-responsive video ratio ratio-16x9" id="videoplay" controlslist="nodownload" poster="../../../build/img/h.jpg">
              <source src="../../build/videos/h.mp4" type="video/mp4">
            </video>
            ...
            <p class="card-text mt-3">Es una consonante fricativa glotal <b>sorda</b>. En esta consonante las cuerdas vocales no vibran. Su producción requiere que estén separadas permitiendo que el flujo de aire pase a través de ellas con poca fricción.</p>
          </div>
        </div>
      </main>
