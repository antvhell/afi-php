...
<main class="flex-grow-1 container">
        <div class="row mt-4">
          ...
          <div class="col-s-12 col-md-6 col-l-6 col-xl-6 videos mt-4">
            <video class="embed-responsive video ratio ratio-16x9" id="videoplay" controlslist="nodownload" poster="../../../build/img/ɸ.jpg">
              <source src="../../build/videos/ɸ.mp4" type="video/mp4">
            </video>
            ...
            <p class="card-text mt-3">Es una consonante fricativa bilabial <b>sorda</b>. Se produce sin la vibración de las cuerdas vocales. En su articulación los labios se posicionan uno muy cerca del otro sin formar una oclusión, por lo tanto, el aire sale de modo continuo produciendo una fricción.</p>
          </div>
        </div>
      </main>
