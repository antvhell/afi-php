...
<main class="flex-grow-1 container">
        <div class="row mt-4">
          ...
          <div class="col-s-12 col-md-6 col-l-6 col-xl-6 videos mt-4">
            <video class="embed-responsive video ratio ratio-16x9" id="videoplay" controlslist="nodownload" poster="../../../build/img/s.jpg">
              <source src="../../build/videos/s.mp4" type="video/mp4">
            </video>
            ...
            <p class="card-text mt-3">Es una consonante fricativa alveolar <b>sorda</b>. Se produce sin vibración de las cuerdas vocales. En su articulación, la parte anterior de la lengua (lámina) se aproxima a los alvéolos creando un pasaje estrecho por donde sale el aire produciendo una fuerte fricción.</p>
          </div>
        </div>
      </main>
