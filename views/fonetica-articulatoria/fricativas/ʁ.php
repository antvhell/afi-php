...
<main class="flex-grow-1 container">
        <div class="row mt-4">
          ...
          <div class="col-s-12 col-md-6 col-l-6 col-xl-6 videos mt-4">
            <video class="embed-responsive video ratio ratio-16x9" id="videoplay" controlslist="nodownload" poster="../../../build/img/ʁ.jpg">
              <source src="../../build/videos/ʁ.mp4" type="video/mp4">
            </video>
            ...
            <p class="card-text mt-3">Es una consonante fricativa uvular <b>sonora</b>. Se produce con vibración de las cuerdas vocales. En su articulación la raíz de la lengua se posiciona en la úvula sin formar una oclusión. De esta manera, el flujo del aire sale continuamente con fricción.</p>
          </div>
        </div>
      </main>
