...
<main class="flex-grow-1 container">
        ...
        <div class="row mt-4 text-center">
          <div class="col-12 mt-4">
            <ul class="nav nav-tabs justify-content-center">
              ...
              <li class="nav-item"><a class="nav-item nav-link active" href="/fonetica-articulatoria/fricativas/simbolos-y-caracteristicas/bloque-1/ejercicio1-3">Ejercicio 3</a></li>
        ...
        <div class="row mt-4">
          <p>1.  Arrastre <b>todos</b> los símbolos que corresponden a la información de cada corchete.</p>
        </div>
        <div class="row mt-4">
          <p>[ Fricativo, sordo ]</p>
          ...
          <div class="col-sm-6 col-md-12 col-lg-6 col-xl-6 mt-2">
            <div id="drag-elements">
              <div class="bien">f</div>
              <div class="bien">ɸ</div>
              <div class="bien">θ</div>
              <div class="mal">ð</div>
            </div>
          </div>
        </div>
        <div class="row mt-4">
          ...
          <div class="col-sm-6 col-md-12 col-lg-6 col-xl-6 mt-2">
            <div id="drag-elements2">
              <div class="bien">v</div>
              <div class="mal">s</div>
              <div class="bien">ʒ</div>
              <div class="bien">β</div>
            </div>
          </div>
        </div>
        <div class="d-flex mb-3 mt-4"><a class="btn btn-outline-primary p-2" href="/fonetica-articulatoria/fricativas/simbolos-y-caracteristicas/bloque-1/ejercicio1-2" role="button">
            ...
            </svg>Ejercicio 2</a><a class="btn btn-outline-primary ml-auto js-btn-next ms-auto p-2" type="button" title="Siguiente" href="/fonetica-articulatoria/fricativas/simbolos-y-caracteristicas/bloque-1/ejercicio1-4">Ejercicio 4
