...
<main class="flex-grow-1 container">
        ...
        <div class="row mt-4 text-center">
          <div class="col-12 mt-4">
            <ul class="nav nav-tabs justify-content-center">
              ...
              <li class="nav-item"><a class="nav-item nav-link active" href="/fonetica-articulatoria/fricativas/simbolos-y-caracteristicas/bloque-3/ejercicio3-2">Ejercicio 2</a></li>
              <li class="nav-item"><a class="nav-item nav-link" href="/fonetica-articulatoria/fricativas/simbolos-y-caracteristicas/bloque-3/ejercicio3-3">Ejercicio 3</a></li>
            </ul>
          </div>
        </div>
        <div class="row mt-4">
          <p>2. Use el teclado y escriba el punto de articulación del símbolo dado, despúes valide.</p>
        </div>
        <div class="row mt-4 align-items-center justify-content-center d-flex justify-content-center">
          <div class="col-sm-1 col-md-1 col-lg-1 text-center">
            <button class="btn btn-info text-charis" type="button">χ</button>
          </div>
        ...
        <div class="row mt-4 align-items-center justify-content-center">
          <div class="col-sm-1 col-md-1 col-lg-1 text-center">
            <button class="btn btn-info text-charis" type="button">ɦ</button>
          </div>
          <div class="col-sm-11 col-md-11 col-lg-5">
        ...
        <div class="row mt-4 align-items-center justify-content-center">
          <div class="col-sm-1 col-md-1 col-lg-1 text-center">
            <button class="btn btn-info text-charis" type="button">ħ</button>
          </div>
          <div class="col-sm-11 col-md-11 col-lg-5">
        ...
        <div class="d-flex mb-3 mt-4"><a class="btn btn-outline-primary p-2" href="/fonetica-articulatoria/fricativas/simbolos-y-caracteristicas/bloque-3/ejercicio3-1" role="button">
            ...
            </svg>Ejercicio 1</a><a class="btn btn-outline-primary ml-auto js-btn-next ms-auto p-2" type="button" title="Siguiente" href="/fonetica-articulatoria/fricativas/simbolos-y-caracteristicas/bloque-3/ejercicio3-3">Ejercicio 3
...
<?php
    $script = "
        <script src='../../../../build/js/fricativas-bloque3.js'></script>
    "
?>