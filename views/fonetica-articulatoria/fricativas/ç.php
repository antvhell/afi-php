...
<main class="flex-grow-1 container">
        <div class="row mt-4">
          ...
          <div class="col-s-12 col-md-6 col-l-6 col-xl-6 videos mt-4">
            <video class="embed-responsive video ratio ratio-16x9" id="videoplay" controlslist="nodownload" poster="../../../build/img/ç.jpg">
              <source src="../../build/vie/ç.mp4" type="video/mp4">
            </video>
            ...
            <p class="card-text mt-3">Es una consonante fricativa palatal <b>sorda</b>. En esta consonante no hay vibración de las cuerdas vocales. En su articulación la parte media de la lengua se posiciona en el paladar duro dejando un canal estrecho por donde sale la corriente de aire de manera continua.</p>
          </div>
        </div>
      </main>
