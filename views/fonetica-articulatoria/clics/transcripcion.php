...
<main class="flex-grow-1 container">
        <div class="row mt-4">
          <div class="col">
            <div class="d-flex"><a class="link-danger link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover opacity-70 flecha" href="../clics/ʘ" title="Regresar">
              ...
              <h2 class="fw-light">Transcripción. Clics</h2>
            </div>
            <p id="indice"></p>
          </div>
        </div>
...
<?php
    $script = "
        <script src='../../build/js/transcripcion-clics.js'></script>
    "
?>