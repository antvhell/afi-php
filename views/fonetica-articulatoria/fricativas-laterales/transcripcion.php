...
<main class="flex-grow-1 container">
        <div class="row">
          <div class="col mt-4">
            <div class="d-flex mb-3"><a class="link-danger link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover opacity-70 flecha" href="/fonetica-articulatoria/fricativas-laterales/ɬ" title="Regresar">
              ...
              <h2 class="titulos fw-light">Transcripción. Fricativas Laterales</h2>
            </div>
            <div class="row">
              <div class="col">
                <div class="d-flex mb-3 p-2"><a class="link-danger link-offset-2 link-underline-opacity-25 link-underline-opacity-100-hover opacity-70 flecha" href="../africadas/ʦ" title="Regresar"></a></div>
                <p id="indice"></p>
              </div>
            </div>
            <div class="container">
              <div class="row">
                <div class="col-12 mt-4 d-flex justify-content-center align-items-center">
                  <div class="audio-container">
                    <audio id="glosas" controls="" controlslist="nodownload">
                      <source src="/sound/apuʔ.wav" type="audio/ogg">
                ...
                <div class="col-12" id="palabra">
                  ...
                  <div class="mt-4">
                    ...
                    <div class="row row d-flex justify-content-center align-items-center mt-2 row-cols-1">
                      <div class="col-sm-12 col-md-8 col-lg-5 col-xl-5">
                        <div class="p text-center alert" id="glosa"></div>
                      </div>
                    </div>
                  </div>
                </div>
                ...
                <form class="col-6 text-center" id="formulario"><br>
...
<?php
    $script = "
        <script src='../../build/js/transcripcion-fricativas-laterales.js'></script>
    "
?>