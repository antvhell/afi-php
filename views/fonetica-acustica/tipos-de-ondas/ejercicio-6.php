        ...
        <div class="row mt-4 text-center">
          <div class="col-12 mt-4">
            <ul class="nav nav-tabs justify-content-center">
              ...
              <li class="nav-ite"><a class="nav-item nav-link active" href="/fonetica-acustica/tipos-de-ondas/ejercicio-6">Ejercicio 6</a></li>
            </ul>
          </div>
        </div>
        <div class="row mt-4">                       
          <p>6. Pulse el tipo de onda mostrada en el oscilograma</p>
        </div>
        <div class="row d-flex justify-content-center align-items-center">
          <div class="col-sm-12 col-xl-8"><img class="oscilogramas" src="../../../build/img/oscilograma-de-l.jpg" alt="Oscilogramade l" srcset=""></div>
          <div class="col-12 d-flex justify-content-center align-items-center">
            <div class="simbolFalse box">Azarosa</div>
            <div class="simbolTrue box">Periódica</div>
          </div>
        </div>
        <div class="d-flex mb-3 mt-4"><a class="btn btn-outline-primary p-2" href="/fonetica-acustica/tipos-de-ondas/ejercicio-5" role="button">
