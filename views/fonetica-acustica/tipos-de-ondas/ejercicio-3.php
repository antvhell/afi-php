...
<main class="flex-grow-1 container">
        ...
        <div class="row mt-4 text-center">
          <div class="col-12 mt-4">
            <ul class="nav nav-tabs justify-content-center">
              ...
              <li class="nav-item"><a class="nav-item nav-link" href="/fonetica-acustica/tipos-de-ondas/ejercicio-2">Ejercicio 2</a></li>
              <li class="nav-item"><a class="nav-item nav-link active" href="/fonetica-acustica/tipos-de-ondas/ejercicio-3">Ejercicio 3</a></li>
        ...
        <div class="row mt-4">                       
          <p>3. Pulse el tipo de onda mostrada en el oscilograma</p>
        </div>
        <div class="row d-flex justify-content-center align-items-center">
          <div class="col-sm-12 col-xl-7"><img class="oscilogramas" src="../../../build/img/oscilograma-de-p.jpg" alt="Oscilogramade p" srcset=""></div>
          <div class="col-12 d-flex justify-content-center align-items-center">
            <div class="simbolTrue box">Quieta-fugaz</div>
            <div class="simbolFalse box">Azarosa</div>
          </div>
        </div>
        <div class="d-flex mb-3 mt-4"><a class="btn btn-outline-primary p-2" href="/fonetica-acustica/tipos-de-ondas/ejercicio-2" role="button">
            ...
            </svg>Ejercicio 2</a><a class="btn btn-outline-primary ml-auto js-btn-next ms-auto p-2" type="button" title="Siguiente" href="/fonetica-acustica/tipos-de-ondas/ejercicio-4">Ejercicio 4
